        ...
        <div className="space-y-2.5 p-3">
            {presets.map((preset) => (
                ...
                <motion.div
                    ...
                    key={preset.id}
                    className="pg-chrome-card group relative overflow-hidden rounded-[18px] bg-ed-subtle text-left transition-colors hover:border-ed-accent/50"
                >
